...
@onready var no_hp_bar: TextureProgressBar = $CanvasLayer/TextureProgressBar


enum TIPO_MOBS{BOSS_001}
@export var tipo_mob:TIPO_MOBS=TIPO_MOBS.BOSS_001
var estrutura={
	"hp":5000,
	"vivo":true,
	"tempo_vivo":15,
...
func _ready() -> void:
	estrutura.hp = 5000 # é um boss
	no_hp_bar.max_value=estrutura.hp
	no_hp_bar.value=estrutura.hp
